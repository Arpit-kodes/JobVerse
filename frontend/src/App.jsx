...
import EditJob from './components/admin/EditJob'      // ✅ NEW: Edit Job route
...
const appRouter = createBrowserRouter([
  ...
  { path: "/admin/jobs/:id/edit", element: <ProtectedRoute><EditJob /></ProtectedRoute> },   // ✅ Add Edit Job Route
